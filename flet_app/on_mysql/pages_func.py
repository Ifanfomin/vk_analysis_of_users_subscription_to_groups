import flet as ft
from config import host, db_user, password, database, vk_token
...
class SearchingScreen(object):
    ...
    def __init__(self):
        self.sql_groups_table = ShowDataBaseTables(host, db_user, password, database).groups
    ...
    def make_info_screens(self):
        ...
        intersec_users = SearchForIntersections(self.selected_groups, host, db_user, password, database).users
        union_users = SearchForUnions(self.selected_groups, host, db_user, password, database).users
        groups_users_count = NumbersOfUsersInGroups(
            self.selected_groups, host, db_user, password,database).groups_id_number_of_users_dict
    ...
    def delete_groups(e):
        ...
        if groups_to_delete:
            for group_id in groups_to_delete:
                DeleteGroupFromBase(group_id, host, db_user, password, database)
